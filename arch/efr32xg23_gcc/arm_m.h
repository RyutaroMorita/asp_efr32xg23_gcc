...
#if !((__TARGET_ARCH_THUMB == 5) || (__TARGET_ARCH_THUMB == 4) || (__TARGET_ARCH_THUMB == 3))
#error __TARGET_ARCH_THUMB is not defined or other than 5(ARMv8)/4(ARMv7)/3(ARMv6)
#endif
 ...
 */
#define _CCR  0xE000ED14 /* core_cm33.h で定義されているため改名 */
...
#define _CPACR 0xE000ED88  /* core_cm33.h で定義されているため改名 */
#define _FPCCR 0xE000EF34  /* core_cm33.h で定義されているため改名 */
